...
# UNIT TO INSTRUCTIONS MAPPING
UNIT_INST_MAP = {
    FP_ADDER: [ADD_DOUBLE, SUBTRACT_DOUBLE],
    FP_MULTIPLIER: [MULTIPLY_DOUBLE],
    FP_DIVIDER: [DIVIDE_DOUBLE],
    INT_AL: [ADD_IMMEDIATE_SIGNED, ADD_SIGNED, SUBTRACT_IMMEDIATE_SIGNED, SUBTRACT_SIGNED, AND_BITWISE, AND_BITWISE_IMMEDIATE, OR_BITWISE, OR_BITWISE_IMMEDIATE]
}